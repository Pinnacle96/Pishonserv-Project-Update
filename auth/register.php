...
<div>
    ...
    <select name="role" id="role" required
        ...
        <?php
$needMou = isset($_SESSION['form_data']['role'])
    && in_array($_SESSION['form_data']['role'], ['agent','owner','hotel_owner','developer','host']);
?>
